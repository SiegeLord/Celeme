...
/// \return The GPA result status of the operation. GPA_STATUS_OK is returned if the operation is successful.
GPA_Status GPA_GetCounterName( gpa_uint32 index, in char** name );
...
/// \return The GPA result status of the operation. GPA_STATUS_OK is returned if the operation is successful.
GPA_Status GPA_GetCounterDescription( gpa_uint32 index, in char** description );
...
/// \return The GPA result status of the operation. GPA_STATUS_OK is returned if the operation is successful.
GPA_Status GPA_GetDataTypeAsStr( GPA_Type counterDataType, in char** typeStr );
...
/// \return The GPA result status of the operation. GPA_STATUS_OK is returned if the operation is successful.
GPA_Status GPA_GetUsageTypeAsStr( GPA_Usage_Type counterUsageType, in char** usageTypeStr );
...
/// \return The GPA result status of the operation. GPA_STATUS_OK is returned if the operation is successful.
GPA_Status GPA_EnableCounterStr( in char* counter );
...
/// \return The GPA result status of the operation. GPA_STATUS_OK is returned if the operation is successful.
GPA_Status GPA_DisableCounterStr( in char* counter );
...
/// \return The GPA result status of the operation. GPA_STATUS_OK is returned if the operation is successful.
GPA_Status GPA_GetCounterIndex( in char* counter, gpa_uint32* index );
...
char* GPA_GetStatusAsStr( GPA_Status status );
